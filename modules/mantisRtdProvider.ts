...
interface MantisOrtb2StructuredData {
  ...
  user?: { data?: MantisSegmentGroup[], ext?: { segtax?: number } };
}
  ...
  const onSuccess = (responseText: string): void => {
    ...
    try {
      ...
      const ortb2StructuredData: MantisOrtb2StructuredData = {
        ...
        user: { data: mantisSegments, ext: { segtax: 4 } }, // https://github.com/InteractiveAdvertisingBureau/Taxonomies/blob/main/Audience%20Taxonomies/Audience%20Taxonomy%201.1.tsv
      };
